...
export const challenges: Challenge[] = [
  ...
  },
  {
    ...
    hint: "Ctrl+B or Left Arrow moves backward by one character.",
    start: "git staus",
    startCursor: 8,
    target: "git status",
    targetCursor: 8,
    focus: "move-char-left",
    focusLabel: "Ctrl+B / Left Arrow",
  ...
  },
  {
    ...
    hint: "Ctrl+F or Right Arrow moves forward by one character.",
    start: "git staus",
    startCursor: 6,
    target: "git status",
    targetCursor: 8,
    focus: "move-char-right",
    focusLabel: "Ctrl+F / Right Arrow",
  ...
  },
  {
    ...
    tier: "basic",
    title: "Clear the final option",
    instructions: ["Remove --no-edit while keeping git commit --amend and its trailing space."],
    hint: "Ctrl+K kills everything from the cursor to the end.",
    start: "git commit --amend --no-edit",
    startCursor: length("git commit --amend "),
    target: "git commit --amend ",
    targetCursor: length("git commit --amend "),
    focus: "kill-to-end",
    focusLabel: "Ctrl+K",
    focusDescription: "clear to end",
    idealKeys: 1,
  ...
  },
  {
    ...
    instructions: ["From after --no-edit, remove that option and its separating space."],
    hint: "Ctrl+W kills the previous word and its separating space.",
    start: "git commit --amend --no-edit message",
    startCursor: length("git commit --amend --no-edit"),
    target: "git commit --amend message",
    targetCursor: length("git commit --amend"),
    focus: "kill-previous-word",
    focusLabel: "Ctrl+W",
    focusDescription: "delete previous word",
